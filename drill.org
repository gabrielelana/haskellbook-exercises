...
*** Answer
Typeclasses defines functions. Typeclasses instances supply an
implementation of those functions for a specific Type.
** Sentence                                                                                 :drill:
...
Typeclass.
** List the functions defined in ~Eq~ Typeclass                                             :drill:
*** Answer
- ~(==) :: a -> a -> Bool~
- ~(/=) :: a -> a -> Bool~
