...
*** Answer
~(<) :: Ord a => a -> a -> Bool~
** The ~if~ is it a /Statement/ or an /Expression/?                                         :drill:
*** Answer
It's an expression
...
*** Answer
~swap :: (a, b) -> (b, a)~
** What have names in Haskell?                                                              :drill:
*** Answer
- Functions
- Term Variables
- Data Constructors
...
- Modules
* Chapter 05
** Why do we want types?                                                                    :drill:
*** Answer
Type systems in mathematics and logic have been designed to impose
