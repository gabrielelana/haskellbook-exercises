...
foldrTree f b (Node left a right) = f a $ foldrTree f (foldrTree f b left) right
:}

:{
foldlTree :: (b -> a -> b) -> b -> BinaryTree a -> b
foldlTree _ b Leaf = b
foldlTree f b (Node left a right) = foldlTree f (f (foldlTree f b left) a) right
:}
...
1. Create a data structure for the phone. [[file:./chapter-011/Phone.hs][Solution]]
