...
#+BEGIN_SRC haskell :tangle chapter-003/Print.hs :epilogue ""
module Print where
...
2. Write all the expressions above as functions in a source file,
   ...
   #+BEGIN_SRC haskell :tangle chapter-003/BuildingFunctions.hs :epilogue ""
...
6. Put that function above into a module in a file
   ...
   #+BEGIN_SRC haskell :tangle chapter-003/Reverse.hs :epilogue ""
