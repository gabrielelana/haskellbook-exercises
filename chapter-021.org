...
9. Write a ~Traversable~ instance for ~S~
   ...
   instance Foldable n => Foldable (S n) where
     -- TODO: it fails, try to check the laws manually
   ...
   [foldMap] *** Failed! Falsified (after 2 tests):
   <function>
   S (Identity 0) (-1)
...
10. Write a ~Traversable~ instance for ~Tree~
    ...
    instance Foldable Tree where
      -- QUESTION: what if we had to implment foldr? How can I require Semigroup?
